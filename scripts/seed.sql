...
CREATE TABLE public.transactions (
  ...
  desination_account_number   TEXT NOT NULL,
...
INSERT INTO public.transactions (origin_account_number, desination_account_number, transaction_timestamp, amount, currency, category, status) VALUES
